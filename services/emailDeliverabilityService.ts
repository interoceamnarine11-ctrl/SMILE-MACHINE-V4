...
import { evaluateGMergeTemplate } from './gmergeEngine';
export { evaluateGMergeTemplate } from './gmergeEngine';
...
export function substituteTemplateVariables(
  ...
  const senderOrganization = recipient.senderOrganization || '';
  const senderEmail = recipient.senderEmail || '';
  const unsubscribeUrl = recipient.unsubscribeUrl || '#';

  return evaluateGMergeTemplate(template, {
    recipient: {
      ...recipient,
      email,
      domain,
